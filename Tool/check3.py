...
def main():
    parser = argparse.ArgumentParser(prog = 'What the *** is wrong with my Illumina Assembly? - Checker', description = 'Multiple alignment of unmapped regions and conflict contigs to detect false positives in the genome mapping')
    subparsers = parser.add_subparsers()

    parser_blast2Unmap = subparsers.add_parser('blast2Unmap', help = 'Alignment of unmapped regions', description = 'BLAST for the unmapped regions with the short-reads assembly')
    ...
    parser_blast2Conf = subparsers.add_parser('blast2Conf', help = 'Alignment of conflict contigs', description = 'BLAST for the conflicted regions with the reference genome')
